...
public class CryptoSettingsFragment extends PreferenceFragmentCompat {
    /**
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        setPreferencesFromResource(R.xml.settings_crypto, rootKey);
        ...
        etp = getPreferenceManager().
                findPreference(getString(R.string.pref_key_crypto_kdf_password));
        if (etp != null) {
            etp.setOnBindEditTextListener(new EditTextPreference.OnBindEditTextListener() {
                @Override
                public void onBindEditText(@NonNull EditText editText) {
