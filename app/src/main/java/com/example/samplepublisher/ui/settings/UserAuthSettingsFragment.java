...
public class UserAuthSettingsFragment extends PreferenceFragmentCompat {
    /**
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        setPreferencesFromResource(R.xml.settings_userauth, rootKey);

        EditTextPreference etp;
        etp = getPreferenceManager().
                findPreference(getString(R.string.pref_key_userauth_username));
        if (etp != null) {
        ...
        etp = getPreferenceManager().
                findPreference(getString(R.string.pref_key_userauth_password));
        if (etp != null) {
            etp.setOnBindEditTextListener(new EditTextPreference.OnBindEditTextListener() {
                @Override
                public void onBindEditText(@NonNull EditText editText) {
